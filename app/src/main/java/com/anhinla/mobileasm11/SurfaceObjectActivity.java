...
public class SurfaceObjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radar.setOnClickListener(v ->{
            Intent intent = new Intent(SurfaceObjectActivity.this, SurfaceActivity.class);
        ...
        imgQr.setOnClickListener(v -> {
            Intent intent = new Intent(SurfaceObjectActivity.this, ScanActivity.class);
            startActivity(intent);
        });
        ImageButton back = findViewById(R.id.back);
        back.setOnClickListener(v ->{
            Intent intent = new Intent(SurfaceObjectActivity.this, ChooseActivity.class);
            startActivity(intent);
        });
        ...
        pos.setOnClickListener( v-> {
                    ...
                    if (ispos) {
                        pos.setBackground(ContextCompat.getDrawable(SurfaceObjectActivity.this, R.drawable.selected_round_button));
                        ...
                        pos.setBackground(ContextCompat.getDrawable(SurfaceObjectActivity.this, R.drawable.round_button));
